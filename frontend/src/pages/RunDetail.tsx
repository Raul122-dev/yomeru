...
import { RunPhaseContent } from "../components/run-detail/RunPhaseContent";
import { useRunDetailData } from "../hooks/run-detail/useRunDetailData";
import { useRunPhaseNavigation } from "../hooks/run-detail/useRunPhaseNavigation";
...
export default function RunDetail() {
  ...
  return (
    <div className="space-y-4">
      ...
      <PhaseBar
        run={run}
        typesetStageStatuses={derived.tsStatuses}
        typesetOutputExists={derived.typesetOutputExists}
        activePhase={activePhase}
      ...
      <RunPhaseContent
        ...
        pages={pages}
        activePhase={activePhase}
        onDetectionDone={() => setActivePhase("analysis")}
